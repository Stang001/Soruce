...
local Script = {
Version = "ask ur dad",
Name = "grrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr"
}
...
local Library = Module.Functions.HttpGet("https://raw.githubusercontent.com/CatzCode/cattoware/main/libraries/ui.lua")
...
local Window = Library:CreateWindow(Script.Name, Vector2.new(492, 598), Enum.KeyCode.V)
